...
export default function WorldMap() {
  ...
  const drag = useRef<{ mode: "none" | "pan" | "item"; id?: string; startX?: number; scrollLeft?: number }>({ mode: "none" });
  ...
  function onPointerDown(e: React.PointerEvent) {
    ...
    if (hit) {
      ...
      drag.current = { mode: "item", id: hit.id };
  ...
  async function onPointerUp() {
    if (drag.current.mode === "item" && drag.current.id) {
